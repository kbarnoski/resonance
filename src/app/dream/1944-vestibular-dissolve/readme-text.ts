...
export const README_TEXT = `Vestibular Dissolve asks one question: what if tilting your device dissolved your sense of "down"? Not a game of balance — a slow, weightless drift toward the dissociative / near-death loss of the body, where the felt gravity vector melts and the boundary between you and a boundless field comes apart.
...
References: the dissociative void and NDE ego-dissolution phenomenology (loss of body schema, floating, cosmic oneness); James Turrell's Ganzfeld work (a boundless, edgeless luminous field); and the vestibular / proprioceptive basis of the gravity vector we usually never notice — until it melts.`;
