// ════════════════════════════════════════════════════════════════════════════
// SONGLINES (3648) — WebGL2 GPU point-cloud renderer, copied from 3608-atlas.
//
...
// Representations."
//
// Songlines adds `atlasToScreen()`, the inverse of `screenToAtlas()`, so a
// plain 2-D overlay canvas (waypoint labels + recorded-loop trail) can be drawn
// in exact register with the GPU cloud beneath it.
// ════════════════════════════════════════════════════════════════════════════
...
export class PointCloudRenderer {
  ...
  /** Inverse of `screenToAtlas` — atlas coords to a CSS-pixel point within a
   *  DOMRect of the given width/height (an overlay canvas the same size). */
  atlasToScreen(ax: number, ay: number, width: number, height: number): [number, number] {
    const clipX = ax * this.fitX;
    const clipY = ay * this.fitY;
