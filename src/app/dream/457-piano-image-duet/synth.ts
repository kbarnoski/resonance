// ─────────────────────────────────────────────────────────────────────────────
// synth.ts — warm, resolving synthesized piano stand-in for "457 Piano
// Image Duet". Fires when Karel's recording cannot be loaded.
//
// Warm tonal progression: C – Am – F – G7 – Cmaj9, with authentic V7→I
// cadence. Never atonal; always resolves on purpose.
// ─────────────────────────────────────────────────────────────────────────────

const PROGRESSION: Array<{ hz: number[]; durationSec: number }> = [
  { hz: [130.81, 164.81, 196.00, 261.63], durationSec: 8  },  // Cmaj
  { hz: [110.00, 130.81, 164.81, 220.00], durationSec: 7  },  // Am
  { hz: [174.61, 220.00, 261.63, 349.23], durationSec: 8  },  // Fmaj
  { hz: [196.00, 246.94, 293.66, 392.00], durationSec: 6  },  // Gmaj
  { hz: [196.00, 246.94, 293.66, 369.99], durationSec: 5  },  // G7
  { hz: [130.81, 164.81, 196.00, 261.63], durationSec: 12 },  // Cmaj9
];

const ARP_STEP_MS = 360;
