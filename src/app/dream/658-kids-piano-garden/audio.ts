// audio.ts — Karel's real solo-piano recording loader + synthesized fallback.
// Client-side only. READ-ONLY of an existing public route; nothing recorded or sent.
...
/**
 * Render a ~12s gentle solo-piano-like buffer with an OfflineAudioContext, so
 * the granular engine always has real harmonic + percussive content to scan.
 */
