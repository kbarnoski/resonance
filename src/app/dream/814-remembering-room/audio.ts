...
//
// (Lifted from 770-answering-room/audio.ts — the soloist contract is identical
//  for this cycle-2; only the agent/memory engine differs.)
...
function renderNote(
  ...
  // A few partials for a slightly bell/piano timbre.
  const partials = [
    { mult: 1, g: 1 },
    { mult: 2, g: 0.32 },
    { mult: 3, g: 0.12 },
