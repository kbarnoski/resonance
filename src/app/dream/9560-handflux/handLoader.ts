// handLoader.ts — MediaPipe Tasks-Vision HandLandmarker, loaded at RUNTIME from a CDN.
//
...
/** Create a two-hand VIDEO-mode landmarker. Throws if the CDN module is
 *  missing or WebGL/WASM is unavailable — callers must catch and degrade. */
