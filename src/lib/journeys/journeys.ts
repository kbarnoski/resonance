...
export const GHOST_ANGEL_WHITE =
  ...
  WINGS_CLAUSE +
  ", wardrobe: SNOW WHITE hair (NEVER blonde, NEVER yellow, NEVER gold), SNOW WHITE translucent dress, SNOW WHITE translucent wispy wings, WHITE particles";
...
export const GHOST_ANGEL_BLACK =
  ...
  WINGS_CLAUSE +
  ", wardrobe: the angel has been possessed and transformed into a dark devil angel under a mysterious spell. JET BLACK hair, JET BLACK translucent shadow-mist dress, JET BLACK translucent wispy wings on her back, BLACK particles, a mysterious shadowed devil-angel character. same body, same pose, same pale luminous skin as the white version — only the wardrobe has flipped to pure black shadow AND the eyes are now open as black voids";
  ...
  },
  {
    ...
    phases: defaultPhases("cosmos", {
      ...
      threshold: {
        ...
        aiPromptSequence: [
          // Spec Section 4 Phase 1 — scene-first, angel tiny within the space.
          "photorealistic cinematic extreme wide establishing shot of a vast ancient dark stone chamber at night, a tall arched stone window far ahead opening onto cosmic void scattered with faint stars, a diagonal shaft of silver moonlight cutting across a worn stone floor cracked with ancient tree roots, deep shadows filling most of the frame. " + GHOST_ANGEL_WINGLESS + " tiny and distant standing alone by the window. mysterious ethereal space, no text no watermarks",
          "photorealistic cinematic low-angle shot looking steeply up at a tall arched stone window that fills most of the frame, cosmic void with stars visible through the window, silver moonlight rimming the stone archway, deep shadows in the dark ancient stone chamber below. " + GHOST_ANGEL_WINGLESS + " a small silhouetted figure at the base of the window. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic side profile silhouette view across a dark ancient stone chamber at night, diagonal shaft of silver moonlight streaming through a tall arched window, ancient stone walls, deep shadows. " + GHOST_ANGEL_WINGLESS + " a small profile silhouette standing by the window, her fibonacci spiral braids catching moonlight with white particles. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic overhead top-down view of a vast ancient stone chamber with worn stone floor cracked by ancient tree roots, a shaft of silver moonlight cutting across the floor from a tall arched window, deep shadows in the corners. " + GHOST_ANGEL_WINGLESS + " a small figure alone on the stone floor below. mysterious ethereal space, no text no watermarks",
          "photorealistic cinematic three-quarter back view from across a vast ancient stone chamber, looking toward a tall arched stone window at the far end opening onto cosmic void, diagonal moonlight shaft across the stone floor cracked with tree roots between the viewer and the window, deep shadows. " + GHOST_ANGEL_WINGLESS + " standing small in the distance by the window. mysterious ethereal, no text no watermarks",
          // Close-up pivot (1 of 6 per spec Section 2: close-ups only at pivots).
          "photorealistic cinematic close-up pivot shot of a hand resting on a worn stone windowsill, ancient tree roots visible cracking through the stone around the hand, soft silver moonlight, one strand of long fibonacci spiral braid draped across the wrist with white particles spiraling along it, pale luminous skin. mysterious ethereal, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      transcendence: {
        ...
        aiPromptSequence: [
          // Spec Section 4 Phase 3 — scene-first wings-find story, 8 beats.
          "photorealistic cinematic wide shot of a magnificent natural cavern deep underground where a vast infinite pool of still dark mirror-water fills the floor and stretches impossibly far in every direction, covered in abundant pure white water lilies (all-white petals, all-white centers, NO yellow), a high vaulted ceiling of gnarled tree roots far above, pale bioluminescent teal glow on the roots. " + GHOST_ANGEL_WINGLESS + " small hovering at the edge of the pool seeing it for the first time. mysterious ethereal infinite pool, no text no watermarks",
          "photorealistic cinematic mid-distance shot of a vast pool of dark mirror-water covered in pure white water lilies (all-white centers, NO yellow), a pair of translucent flowing wispy angel wings made of pure light and mist floating on the water's surface between the lilies with a soft halo of white light around them, inside a magnificent deep-earth cavern with gnarled tree roots. " + GHOST_ANGEL_WINGLESS + " small leaning down looking at the wings in recognition. mysterious ethereal, no text no watermarks",
          // Close-up pivot #1 per spec (wings lift).
          "photorealistic cinematic close-up pivot shot of two hands lifting a pair of translucent flowing wispy angel wings of light and mist (like smoke or silk) up out of dark mirror-water, droplets falling from the wisps of light, pure white water lilies visible in the background water, a soft halo of white light around the wings, one fibonacci spiral braid with white particles draped across a wrist, pale luminous skin. mysterious ethereal, no text no watermarks",
          // Close-up pivot #2 per spec (wings attach).
          "photorealistic cinematic close-up pivot shot of translucent flowing wispy wings of light and mist attaching anatomically to pale luminous skin at the upper back shoulder blades, a burst of pure white light and swirling white particles exploding outward, dark mirror-water with white lilies visible at the edges of the frame, magnificent natural cavern around. mysterious ethereal transformation, no text no watermarks",
          "photorealistic cinematic overhead top-down view of a vast pool of dark mirror-water covered in pure white water lilies inside a magnificent deep-earth cavern. " + GHOST_ANGEL + " newly winged hovering horizontally above the water with body spread wide, her PERFECT REFLECTION clearly visible in the mirror-water directly below matching her pose, new translucent wispy wings of light spread, white water lilies scattered around her reflection. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic low-angle shot from water level looking up past pure white water lilies into a magnificent deep-earth cavern with gnarled root ceiling far above, pale bioluminescent teal glow. " + GHOST_ANGEL + " hovering above the pool with translucent wispy wings of light spread. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic three-quarter view of a vast pool of dark mirror-water covered in pure white water lilies, a distant warm golden light glowing at the far end of the natural cavern passage ahead. " + GHOST_ANGEL + " hovering above the pool with wings spread, turning to face the distant light. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic rear tracking wide shot of a vast infinite pool of dark mirror-water covered in pure white water lilies stretching ahead to a distant warm golden light glowing at the far end of the natural cavern passage. " + GHOST_ANGEL + " small hovering forward across the pool toward the light, wings spread, lilies rippling in her wake. mysterious ethereal, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      illumination: {
        ...
        aiPromptSequence: [
          // Spec Section 4 Phase 4 — scene-first, 6 beats with 1 close pivot.
          "photorealistic cinematic wide shot of the dark mouth of a deep-earth root passage opening out onto vast open infinite cosmos, the entire universe sky of stars nebulae and spiral galaxies visible ahead, a distant dark dead gnarled tree on its own small round spherical dark rocky planet far ahead. " + GHOST_ANGEL + " small emerging from the passage into cosmos. mysterious ethereal cosmic dawn, no text no watermarks",
          "photorealistic cinematic extreme wide establishing shot of infinite cosmos with a dark dead gnarled tree standing alone on its own perfectly round spherical dark rocky planet (a complete planet, not a chunk, not a crystal island, not a fragment), the entire universe sky filled with countless stars vast colorful nebulae and distant spiral galaxies as backdrop. " + GHOST_ANGEL + " tiny flying through cosmos toward the tree-planet. mysterious ethereal cosmic scale, no text no watermarks",
          "photorealistic cinematic mid-distance view of a dark dead gnarled tree standing on its round spherical planet hovering in infinite cosmos, distant warm golden cosmic dawn glow behind rimming the dead branches with faint amber, universe sky of stars nebulae galaxies as backdrop. " + GHOST_ANGEL + " flying forward body angled forward arms slightly raised, dress and braids streaming back. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic low-angle shot looking up at the dark gnarled silhouette of a dead tree on its round spherical planet against an infinite cosmos of stars nebulae and spiral galaxies, distant warm golden cosmic dawn glow behind. " + GHOST_ANGEL + " small glowing figure flying up from below toward the tree. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic three-quarter behind-the-shoulder view framing a dark dead tree on its round spherical planet growing large directly ahead in infinite cosmos, universe sky of stars nebulae galaxies filling the backdrop, distant warm golden cosmic dawn. " + GHOST_ANGEL + " small in the foreground flying toward the tree. mysterious ethereal, no text no watermarks",
          // Close-up pivot (1 of 6): braids + tree context.
          "photorealistic cinematic close-up pivot side shot of long fibonacci spiral braided hair streaming forward past shoulders with white particles spiraling along the braids, a dark dead gnarled tree on its spherical planet visible clearly in the background, universe sky of stars behind. mysterious ethereal, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      return: {
        ...
        aiPromptSequence: [
          // Spec Section 4 Phase 5 — six bloom stages of progression.
          // Stage 1 — hand on dead trunk, first 2-3 tiny flowers.
          "photorealistic cinematic close-up pivot of a hand resting on dark lifeless gnarled tree bark on a spherical planet in cosmos, only the first 2 or 3 tiny pure white flowers (all-white petals, all-white centers, NO yellow) emerging from the bark right at the fingertips, the rest of the branches completely bare and dead visible in the background, warm golden cosmic dawn glow behind, universe sky. mysterious ethereal, no text no watermarks",
          // Stage 2 — halo of ~20 flowers around her hand, rest bare.
          "photorealistic cinematic mid shot at the base of a dark dead gnarled tree on its spherical planet with a cluster of ~20 pure white flowers (all-white petals, all-white centers, NO yellow) opened in a halo around a hand pressed on the trunk, every other branch of the tree still bare and dead, the spherical planet below, cosmos of stars nebulae galaxies as backdrop. " + GHOST_ANGEL + " small at the trunk. mysterious ethereal, no text no watermarks",
          // Stage 3 — half blooming, half bare, bloom wave expanding.
          "photorealistic cinematic mid-distance shot of an ancient gnarled tree on its spherical planet with roughly half the branches partially bloomed with pure white flowers (all-white centers, NO yellow) and half still bare and dead, a visible wave of bloom expanding outward across the branches, cosmos of stars nebulae galaxies behind. " + GHOST_ANGEL + " small with her hand on the trunk. mysterious ethereal, no text no watermarks",
          // Stage 4 — full bloom across every branch.
          "photorealistic cinematic wide shot of an ancient gnarled tree on its round spherical planet with every branch now completely covered in pure white flowers (all-white petals, all-white centers, NO yellow), the previously dead tree now fully alive in white bloom, warm golden light streaming through the branches, universe sky of stars nebulae galaxies backdrop. " + GHOST_ANGEL + " small at the trunk. mysterious ethereal, no text no watermarks",
          // Stage 5 — body becoming translucent, wood grain through skin.
          "photorealistic cinematic front view of an ancient gnarled tree fully covered in pure white flowers (all-white centers, NO yellow) on its spherical planet in cosmos, warm golden light streaming through every branch in radiant shafts. " + GHOST_ANGEL + " with her body beginning to become translucent and wood grain showing through her skin and dress, fibonacci spiral braids starting to blend into the branches, translucent wispy wings starting to become branch-shapes of light. mysterious ethereal transcendent union, no text no watermarks",
          // Stage 6 — merge complete.
          "photorealistic cinematic wide shot of an ancient gnarled tree on its round spherical planet in infinite cosmos with every branch fully covered in pure white flowers, warm golden cosmic dawn behind, universe sky of stars nebulae galaxies. " + GHOST_ANGEL + " fully merged into the tree with only faint traces of her body visible in the wood grain, her fibonacci braids now are branches and her translucent wispy wings now are branch-shapes of light. mysterious ethereal transcendent union, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      integration: {
        ...
        aiPromptSequence: [
          // Spec Section 4 Phase 6 — scene-first, 6 soaring beats with 1 close pivot.
          "photorealistic cinematic wide shot of a blooming tree-planet covered in pure white flowers seen far below, golden cosmos ahead filled with volumetric amber sunrays, deep indigo cosmos pierced by light, distant stars nebulae galaxies. " + GHOST_ANGEL + " rising upward from the planet with translucent wispy wings of light spread trailing golden particles. mysterious ethereal release, no text no watermarks",
          "photorealistic cinematic low-angle looking up at infinite golden cosmos above pierced by volumetric amber sunrays, warm light streaming. " + GHOST_ANGEL + " ascending with both arms outstretched upward and head tilted back, translucent wispy wings of light fully spread above her trailing dense golden particles, fibonacci braids streaming with white and gold particles. mysterious ethereal transcendent flight, no text no watermarks",
          "photorealistic cinematic three-quarter tracking shot across infinite golden cosmos pierced by volumetric amber sunrays, deep indigo deep-space backdrop, distant stars and galaxies. " + GHOST_ANGEL + " soaring horizontally through the golden light, body angled upward with arms outstretched, translucent wispy wings spread trailing dense golden particle streams, fibonacci braids streaming back with white and gold particles. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic extreme wide silhouette shot of a vast golden-nebula cosmos filled with stars and distant spiral galaxies, volumetric amber sunrays everywhere across infinite scale. " + GHOST_ANGEL + " tiny and radiant silhouette soaring across the cosmos, translucent wispy wings spread trailing golden particles. mysterious ethereal cosmic freedom, no text no watermarks",
          "photorealistic cinematic distant figure wide shot of deep indigo cosmos pierced by volumetric amber sunrays filled with stars nebulae and spiral galaxies. " + GHOST_ANGEL + " small flying through the golden light, translucent wispy wings spread trailing dense golden particles. mysterious ethereal, no text no watermarks",
          // Close-up pivot (1 of 6): face with eyes closed ecstatic.
          "photorealistic cinematic close three-quarter pivot of a face with eyes closed in ecstatic peaceful expression, head tilted back, warm golden light washing across pale luminous features, fibonacci spiral braids streaming back with white and gold particles, translucent wispy wings of light visible spread at her back, golden cosmos around her. mysterious ethereal transcendent, no text no watermarks",
        ],
        aiPromptModifiers: {
