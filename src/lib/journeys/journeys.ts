  ...
  },
  {
    ...
    phases: defaultPhases("cosmos", {
      ...
      expansion: {
        ...
        shaderOpacity: 0.65,
        aiPrompt: "photorealistic view looking into a mysterious ancient stone opening in the earth anchored in the lower-right third of the frame — rough dark stone framed by tangled roots and pale bioluminescent lichen, the portal itself not filling the frame but a focal element within vast surrounding darkness, the upper-left two-thirds deep black void with only sparse floating spectral particles and the faintest wisps of luminous spores drifting across — open dark space where shader light bleeds through, at the portal threshold a small dark feminine angelic form draped in ethereal flowing fabric seen from behind entering ahead of you — no face visible, her impossibly long grey wispy hair in divine Leonardo fibonacci spiraling curls streaming down into the dark depth trailing luminous particles, some hair strands extending far upward and leftward into the dark void above as delicate isolated threads of light against blackness, beside her a translucent spirit duplicate already deeper — the soul leading inward, the stone surface photorealistic with erosion and moisture — roots threading through cracks, patches of cold bioluminescence, the darkness within the portal magnetic and bottomless, scattered organic elements — a single pale root tendril crossing the dark void, a floating spore cluster in the upper portion, a wisp of luminous fungal thread — isolated small elements creating depth in the negative space without filling it, the mood deeply haunting and spacious — vast darkness with an intimate portal moment, cool silver and organic earth tones, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      // Mix of tunnel views and more open compositions with floating elements.
      transcendence: {
        start: 0.35,
        end: 0.63,
        shaderOpacity: 0.72,
        aiPrompt: "photorealistic underground tunnel system carved through ancient dark stone — the passage visible in the lower-right portion of the frame curving into depth, the upper-left half deep black void — an impossibly tall cavern ceiling lost in darkness where only scattered bioluminescent points float like underwater stars, the stone walls rough and wet catching faint light from bioluminescent growth, pale organic luminescence and spectral particles swirling through the tunnels like living currents, a tall statuesque dark feminine angelic form in the tunnel seen from behind draped in flowing ethereal fabric — her grey wispy hair in divine Leonardo fibonacci spiraling curls trailing upward into the vast dark ceiling void, the hair becoming isolated luminous threads crossing the dark empty space overhead like a constellation map, beside her a translucent spirit duplicate separating and drifting ahead, far across the dark void a second figure barely visible — only her trailing spiral hair and particle trail, a floating fragment of stone with bioluminescent growth drifting in the upper void — a small isolated element adding depth without filling the space, the hair streams from all figures threading through the darkness creating a spiraling luminous web, spectral particles sparse in the vast dark air, photorealistic wet dark granite with veins of pale mineral, in the far distance the faintest suggestion of warmer light, no faces visible, the mood haunting and subterranean with vast vertical dark space, deep indigo and spectral silver with amber bioluminescent accents, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      illumination: {
        ...
        shaderOpacity: 0.72,
        aiPrompt: "photorealistic surreal impossible landscape — emerging from dark underground stone into vast open cosmic space, the frame dominated by deep cosmic void — generous dark emptiness filling the right two-thirds with scattered distant stars, a single massive ancient gnarled tree rooted in a floating island of dark earth anchored in the upper-left corner, its roots extending downward through open air into the deep void below becoming luminous filaments connecting to distant star clusters, the tree occupying roughly one-third of the frame leaving vast open darkness, woven through the branches a tall statuesque dark feminine angelic form draped in flowing ethereal fabric — turned away and partially hidden, no face visible, her grey wispy hair in divine Leonardo fibonacci spiraling curls streaming downward along the trunk and through roots becoming luminous connections to the cosmos, a single isolated floating element in the void — a small fragment of stone with trailing moss drifting far from the tree like a satellite, adding depth to the negative space, a translucent spirit duplicate slowly separating into the cosmos, a second figure barely a wisp of particles and hair far below in the void, all figures photorealistic and ethereal — emerging from spectral particles not solid bodies, the mood haunting but opening — underground darkness giving way to overwhelming cosmic scale, no halos, no detailed faces, photorealistic bark texture, deep earth tones and spectral silver-blue, NOT illustration style — photorealistic materials and lighting throughout, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      return: {
        ...
        aiPrompt: "photorealistic vast dark cosmic space warming from deep indigo-black at the lower edges to the subtlest amber glow in the upper-right — the frame mostly deep void with generous dark emptiness, multiple dark silhouetted feminine figures draped in ethereal flowing fabric ascending at different heights anchored in the left third — not filling the frame but intimate forms within cosmic vastness, the nearest in the lower-left seen from behind with very long dark hair in divine da Vinci spiraling curls interwoven with threads of golden light streaming upward, no halo — only the warmth of the light catching the dark silhouette, the body dissolving into warmth and trailing particles from the waist down, above two more distant figures higher and more transparent, their Mucha-style flowing hair streaming downward becoming ribbons of warm light, a small isolated floating element — a single luminous ember cluster or a wisp of golden particle spiral drifting alone in the vast right void, hair transitioning from cool silver at the lowest tendrils to warm gold at the highest, fine luminous particles trailing like embers rising, generous dark void filling the lower half and right — the darkness of earlier phases finally breaking as warmth enters, NOT illustration — photorealistic lighting and materials, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
      ...
      integration: {
        ...
        aiPrompt: "photorealistic warm golden radiance flooding vast cosmic space from the upper-right — deep indigo-black receding to the far edges as amber-gold light fills the upper portion like sunrise through the cosmos itself, volumetric golden rays streaming diagonally, in the upper-right portion a tall statuesque luminous feminine angelic figure seen from behind or distant profile — absolutely NO detailed face visible only dark silhouette against golden light, the figure not filling the frame but anchored in the right third with generous dark void on the left, overwhelmingly long grey wispy hair in divine Leonardo da Vinci fibonacci spiraling curls interlaced with threads of pure gold light — the hair impossibly abundant and alive, flowing in massive spiraling cascades trailing behind and downward filling the space with Alphonse Mucha-style Art Nouveau flowing organic curves, individual hair strands becoming luminous particle threads that spiral outward in fibonacci patterns, the figure more hair and light than body — from the waist down dissolving into thousands of warm golden particles descending gently, small isolated floating elements scattered in the dark void — a spiral of golden particles drifting alone, a wisp of luminous hair disconnected and floating like a jellyfish tendril, fragments of light, the smaller ghost figure far below in the lower-left still dark and translucent — grey wispy fibonacci spiral hair streaming upward connecting to the figure above, all figures emerging from particles and light not solid bodies — NEVER showing detailed facial features only silhouettes and dark profiles, the hair IS the subject — divine spiraling cascading luminous particle hair filling space with organic mathematical beauty, NOT illustration style — photorealistic volumetric golden light and real material textures, no text no signatures no watermarks no letters no writing",
        aiPromptModifiers: {
