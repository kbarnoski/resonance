    ...
    phases: defaultPhases("cosmos", {
      ...
      transcendence: {
        ...
        aiPromptSequence: [
          ...
          "photorealistic cinematic overhead top-down wide view of a vast pool of dark mirror-water covered in pure white water lilies inside a magnificent deep-earth cavern. " + GHOST_ANGEL_WINGLESS + " small and hovering just above the surface with her body spread wide, long white spiral hair fanning around her on the water — BUT her REFLECTION in the mirror-water below does NOT match: the reflection is a DARK possessed angel version of her with jet black dress and darkness around where the wings should be, looking up at her from beneath the water, eerie and silent. mysterious ethereal unsettling, no text no watermarks",
          "photorealistic cinematic wide side shot of the surface of a vast dark mirror-water pool covered in pure white water lilies, below the surface a dark possessed angel figure in a jet black dress looking upward, above the surface a small white-haired angel hovering in mid-air staring down. " + GHOST_ANGEL_WINGLESS + " small with her back/side toward the camera hovering above the water looking down at her dark reflection, long white spiral hair cascading forward, white particles trailing. mysterious ethereal unsettling, no text no watermarks",
          ...
          "photorealistic cinematic wide shot of the moment the translucent JET BLACK wispy wings merge and attach to a small figure's upper back at the shoulder blades above a vast dark mirror-water pool covered in pure white water lilies, a burst of dark particles exploding outward, the white dress has turned to a JET BLACK translucent shadow dress, her hair stays SNOW WHITE. " + GHOST_ANGEL + " (with the newly dark dress and dark wings, white hair) small silhouetted against the dark burst, back to camera, long white spiral hair rippling in the dark burst, magnificent deep-earth cavern around. mysterious ethereal possession, no text no watermarks",
          "photorealistic cinematic wide rear view of a vast magnificent deep-earth cavern with a pool of dark mirror-water covered in pure white lilies behind, a distant warm teal-amber light glowing at the far end of the cavern passage ahead. " + GHOST_ANGEL + " (now black-dressed black-winged, white hair) small hovering forward above the water toward the distant light, back to the camera, translucent black wispy wings spread, long white spiral hair streaming back, black particles trailing with scattered white particles from her hair. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic extreme wide shot of " + GHOST_ANGEL + " tiny and distant flying through a vast epic underground cavern toward a distant warm amber-teal light at the far end, massive gnarled tree roots forming the colossal cavern, pale bioluminescent teal glow, her white hair long and streaming behind, translucent black wispy wings spread, black dress, back to the camera. mysterious ethereal cave flight, no text no watermarks",
          "photorealistic cinematic wide rear tracking shot of " + GHOST_ANGEL + " small flying through a magnificent deep-earth cavern toward a growing warm amber light glowing at the far exit, her back to the camera, translucent black wispy wings spread trailing black particles, long white spiral fibonacci hair cascading and trailing in the air with mixed black and white particles, flower lilies on the dark water below. mysterious ethereal, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      illumination: {
        ...
        aiPromptSequence: [
          ...
          // flies toward it. Flash #2 fires at arrival (end of phase).
          "photorealistic cinematic wide shot of the dark mouth of a deep-earth root passage opening out onto vast open infinite cosmos, the entire universe sky of stars nebulae and spiral galaxies visible ahead, a distant small dark dead gnarled tree standing on its own tiny round spherical planet far ahead, a warm sunset-amber glow behind the tree. " + GHOST_ANGEL + " (black dress, black wings, white hair) small emerging from the passage into cosmos with her back to the camera, long white spiral hair trailing, black wings spread. mysterious ethereal cosmic dawn, no text no watermarks",
          "photorealistic cinematic extreme wide establishing shot of infinite cosmos with a small dark dead gnarled tree standing alone on its own tiny round spherical planet in the middle distance, the entire universe sky filled with countless stars vast colorful nebulae and distant spiral galaxies as backdrop, a distant warm sunset orange-amber glow behind the tree-planet. " + GHOST_ANGEL + " (black dress, translucent black wings, white spiral hair) tiny and distant flying through cosmos toward the small tree-planet. mysterious ethereal cosmic scale, no text no watermarks",
          "photorealistic cinematic mid-distance back view of a small dark dead tree on its tiny spherical planet hovering in infinite cosmos, warm sunset glow behind rimming the dead branches with amber and rose, universe sky of stars nebulae galaxies as backdrop. " + GHOST_ANGEL + " (black dress, black wings, white hair) small flying forward with her back to the camera, body angled forward arms slightly raised, translucent black wings spread trailing black particles, long white spiral hair streaming with mixed black and white particles. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic low-angle wide shot looking up at the silhouette of a small dark dead tree on its tiny spherical planet against an infinite cosmos of stars nebulae and spiral galaxies with a sunset glow behind. " + GHOST_ANGEL + " (black-dressed, black-winged, white-haired) small glowing silhouette flying up from below toward the tree-planet, face not visible. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic three-quarter behind-the-shoulder wide view framing a small dark dead tree on its tiny spherical planet directly ahead in infinite cosmos, universe sky of stars nebulae galaxies and sunset glow as backdrop. " + GHOST_ANGEL + " (black dress, translucent black wings, white spiral hair) small in the foreground flying toward the tree-planet with her back to the camera, long white hair trailing, arms outstretched forward as if reaching. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic wide shot of " + GHOST_ANGEL + " (black-winged black-dressed white-haired) approaching very close to the small dark dead tree on its tiny planet in cosmos, back to the camera, arms reaching forward, the tree silhouetted against a vast warm sunset glow and the entire universe sky of stars nebulae galaxies. mysterious ethereal cosmic arrival, no text no watermarks",
          "photorealistic cinematic wide arrival shot of " + GHOST_ANGEL + " arriving at the small dark dead tree on its tiny spherical planet, her form beginning to TRANSFORM back — the translucent black wings starting to flicker and dissolve into white light, her jet black dress beginning to brighten into white translucent mist, against the sunset glow and universe sky behind. back to camera, long white spiral hair catching the transformation light. mysterious ethereal transformation, no text no watermarks",
        ],
        aiPromptModifiers: {
      ...
      return: {
        ...
        aiPromptSequence: [
          // Spec v3 §4 Phase 5 — WHITE angel returned (flash #2 just fired).
          // Tree begins to bloom as she arrives. Seen from GREAT distance
          // throughout this phase per user's directive. The close-up work
          // is at the tree, not her face.
          "photorealistic cinematic extreme wide establishing shot of " + GHOST_ANGEL + " (fully returned to WHITE — snow white spiral hair, WHITE translucent dress, WHITE translucent wispy wings, WHITE particles) hovering small next to a small dark gnarled tree on its tiny spherical planet in vast infinite cosmos, warm sunset glow behind the tree, universe sky of stars nebulae and galaxies, the tree has NO flowers yet — bare dark branches awaiting her touch. mysterious ethereal arrival, no text no watermarks",
          "photorealistic cinematic wide shot of a small gnarled tree on its tiny spherical planet in infinite cosmos with a few (maybe 5-8) tiny pure white flowers (all-white petals, all-white centers, NO yellow) just starting to emerge on the branches, the rest of the branches still bare, warm sunset glow behind, universe sky. " + GHOST_ANGEL + " (white variant) small next to the tree with her back to the camera, long white spiral hair cascading to the planet surface, arms reaching toward the tree trunk. mysterious ethereal first-bloom, no text no watermarks",
          "photorealistic cinematic extreme wide shot of a small gnarled tree on its tiny spherical planet in vast infinite cosmos, roughly a quarter of the branches now showing small pure white blossoms (all-white centers, NO yellow) in scattered clusters, a visible wave of bloom expanding outward. " + GHOST_ANGEL + " (white) tiny next to the tree with her back to camera, long white spiral hair trailing, cosmos of stars nebulae galaxies behind. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic wide low-angle shot looking up at a small gnarled tree on its tiny spherical planet with roughly half the branches bloomed with pure white flowers and half still bare, warm sunset glow and universe sky behind. " + GHOST_ANGEL + " (white) small at the tree base silhouette against the sunset, long white spiral hair cascading down and trailing up in the cosmic air. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic extreme wide shot of a small gnarled tree on its tiny spherical planet fully covered in pure white flowers (all-white centers, NO yellow), the previously dead tree now fully alive in white bloom, warm sunset glow behind rimming everything in amber and rose, universe sky of stars nebulae galaxies backdrop. " + GHOST_ANGEL + " (white, peak adult form) small and silhouetted at the trunk with her back to camera, long white hair cascading, radiant light surrounding her. mysterious ethereal, no text no watermarks",
          "photorealistic cinematic wide back-three-quarter view of a small gnarled tree fully covered in pure white flowers on its tiny spherical planet in cosmos, warm golden light streaming through every branch in radiant shafts. " + GHOST_ANGEL + " (white, peak adult form) small with her back to the camera, body beginning to become translucent and wood grain showing through her translucent skin and dress, long white spiral fibonacci hair starting to blend into the blooming branches, translucent wispy wings starting to become branch-shapes of light. mysterious ethereal transcendent union, no text no watermarks",
