...
const WORLDS = {
  ...
  "Welcome Home": { // motifs: distant window-light, snow, hearth amber, the path home
    ...
    phases: [
      ...
      "cosmic — from far above the night, the snowbound valley shrunk to a dark fold on the curved sleeping earth, one ember of window-light glowing at its heart, the thin silver smoke thread climbing all the way up toward a sky deep with stars and high luminous cloud, the warmth and the universe in one frame",
  ...
  "Stir Crazy": { // motifs: leaf-and-ember vortex, stone cylinder, violet static, release
    ...
    phases: [
      ...
      "cosmic — the vortex from far above at night, its ember spiral vast and glowing like a storm on a gas planet, bands of orange and violet turning at different speeds around the dark calm eye, lit debris streaking the outer rings, trapped fury at planetary scale",
  ...
  "Quarantine": { // motifs: rain-beaded glass, one amber interior reflection, two worlds one pane
    ...
    phases: [
      ...
      "abstract — inside one raindrop as a curved glass world, the storm outside bent into sweeping ribbons of silver-blue light arcing around the viewpoint, the room's amber reflection hanging in the curve like a small warm planet, weightless suspension between two weathers",
  ...
  "All Together": { // motifs: scattered lights, luminous tributaries, the confluence river, delta
    ...
    phases: [
      ...
      "cosmic — the gathering seen from the edge of night, the dendritic river-of-light network sprawling across a dark curved landmass like a galaxy lying down on the earth, every tributary a star-stream bending toward one bright confluence core, black space above the curve",
