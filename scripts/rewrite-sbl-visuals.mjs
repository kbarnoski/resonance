...
const WORLDS = {
  ...
  "Grace": {
    ...
    phases: [
      "DARK BACKGROUND — high dark sky over silhouetted pine ridges, one slow meteor drawing a silent gold thread down the upper right of the frame, its light landing softly beyond the ridge without violence, faint rose afterglow where it passed, the forest holding its breath in the lower dark third, a single act of giving, enormous night around it",
