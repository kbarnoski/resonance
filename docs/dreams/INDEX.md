...
## ⭐ Newest (Cycle 352 — kids build · DEEP, one ARTICULATORY-MIRROR concept via 3 renderers; winner is the lab's first formant-to-tongue **articulatory-inversion** toy + its first use of real **LPC** formant tracking — a child sings a vowel and *sees inside the mouth*)
