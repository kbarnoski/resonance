...
### `329-voice-cathedral` — sing one note and it blooms into an HRTF-spatialized overtone choir that ORBITS your head; a spatial chord you build with your voice, with the notes named `[queued, BUILD-CLEAN this fire — RE-FLAGGED as the TOP next-adult build: the lab's SECOND non-screen piece]`
