...
### `live-duet-harmonist` — a continuous comping bed (bass + voiced pad) under your chords `[seed from cycle 275 DEEP non-winner, build-verified — BUILD THIS NEXT adult cycle]`
